                    ...
                    <div class="row">
                        ...
                        <div class="logo">
                            <a href="index.html" title="">
                                <img src="assets/img/payment.png" alt="Logo" />
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="payment.php" class="fa-comment active">Payment</a>
                                    </li>    
                            ...
                            <div class="container">
							  <div class="card"></div>
								...
								<form method="POST" action="receipt.php">
								  <a href="https://axisremit.axisbank.co.in"> <h1>NetBanking</h1> </a><br>
								  <a href="https://paytm.com"> <h1>Paytm</h1> </a><br>
								  <a href="https://www.bhimupi.org.in"> <h1>Bhim</h1> </a><br>
								  <a href="https://www.onlinesbi.com"> <h1>Debit Card</h1> </a><br>

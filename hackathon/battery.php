                    ...
                    <div class="row">
                        ...
                        <div class="logo">
                            <a href="index.html" title="">
                                <img src="assets/img/battery.png" alt="Logo" />
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
                        ...
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="" class="fa-copy ">Registration</a>
                                        
                                    </li>
                                    <li>
                                        <a href="battery.php" class="fa-th active">Battery</a>
  ...
  <div class="card">
    ...
    <form action="payment.php" method="post">
      <div class="input-container">
        ...
        <input type="number" name="oldbattery" required="required"/>
        <label for="Oldbattery">Old Battery No</label>
        <div class="bar"></div>
      </div>
      <div class="input-container">
        <input type="number" name="newbattery" required="required"/>
        <label for="Newbattery">New Battery No</label>
        <div class="bar"></div>
      </div>
	  <div class="input-container">
